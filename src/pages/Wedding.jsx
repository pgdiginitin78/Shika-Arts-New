...
const MENUS = [
  {
    ...
    subCategory: [
      { name: "Physical Invites", tag: "physical invites" },
      { name: "Digital Invites", tag: "digital invites" },
      { name: "Luxury Box Invites", tag: "luxury box invites" },
    ],
  },
  {
    category: "Wedding Hampers",
    subCategory: [
      { name: "Bridesmaid Boxes", tag: "Wedding" },
      { name: "Groomsmen Kits", tag: "Wedding" },
      { name: "Guest Welcome Kits", tag: "Wedding" },
      { name: "Return Gifts", tag: "Wedding" },
    ],
  },
];
...
export default function Wedding() {
  ...
  const { data: products = [], isLoading } = useQuery({
    queryKey: ["products", "Wedding", activeTag],
    queryFn: async () => {
      let queryStr = `product_type:"Wedding" OR ${ALL_TAGS_AND_TYPES_QUERY}`;
      if (activeTag) {
