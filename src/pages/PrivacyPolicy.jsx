    ...
    <div className="min-h-screen bg-white pt-5 pb-20">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <Section title="1. Information We Collect">
          ...
          address, and payment details. We also collect usage data automatically through cookies and
          similar technologies.
        </Section>

        <Section title="2. How We Use Your Information">
          Your information is used to process and fulfil orders, send order confirmations and
          updates, respond to customer enquiries, improve our website and services, and — with your
          consent — send you marketing communications about new products and promotions.
        </Section>
        ...
        <Section title="3. Sharing Your Information">
          ...
          fulfilling your order or operating our services. All partners are bound by confidentiality
          obligations.
        </Section>

        <Section title="4. Cookies">
          We use essential cookies to keep your cart and session active, and optional analytics
          cookies to understand how visitors use our site. You can manage or disable cookies through
          your browser settings at any time.
        </Section>

        <Section title="5. Data Retention">
          We retain your personal data only as long as necessary to fulfil the purposes outlined in
          this policy or as required by applicable law. Order records are kept for up to 7 years for
          accounting purposes.
        </Section>
        ...
        <Section title="7. Security">
          ...
          payment gateways to protect your information. However, no method of transmission over the
          internet is 100% secure.
        </Section>

        <Section title="8. Changes to This Policy">
          We may update this Privacy Policy from time to time. Changes will be posted on this page
          with an updated date. Continued use of our site after changes constitutes acceptance of
          the revised policy.
        </Section>
